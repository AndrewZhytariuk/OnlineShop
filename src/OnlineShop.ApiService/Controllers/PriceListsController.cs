...
namespace OnlineShop.ApiService.Controllers
{
    ...
    {
        public PriceListsController(IRepoClient<PriceList> repoClient, IClientAuthorization clientAuthorization) : base(repoClient, clientAuthorization) { }

        [HttpPost(RepoActions.Add)]
        public async Task<IActionResult> Add([FromBody] PriceList entity)
        {
        ...
        public async Task<IActionResult> Add([FromBody] IEnumerable<PriceList> entitis)
        {
        ...
        public async Task<IActionResult> Update([FromBody] PriceList entry)
        {
